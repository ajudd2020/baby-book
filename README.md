...
For starters, I am very proud of this app because I built it in a matter of days using technology that is *bascially* new to me. Developing for mobile devices is very different, and using a cloud-based storage system and a non-relational database was *very* weird (I never thought I'd say this, but I actually kind of miss SQL!). Yes, there is still a lot that I need to add. But, for now, I'm proud of my little mobile app. I'm not sure if it will ever see deployment... But, it will always have a very special place in my heart.
